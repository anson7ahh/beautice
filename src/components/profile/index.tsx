...
const Profile = () => {
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-1 text-sm font-semibold text-gray-900 shadow-sm ring-gray-300 hover:bg-gray-50">
          <UserCircleIcon
            aria-hidden="true"
            className="-mr-1 size-7 text-gray-400"
          />
          <ChevronDownIcon
            aria-hidden="true"
            className="-mr-1 size-7 text-gray-400"
