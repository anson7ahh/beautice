...
const BlogItems: FC<Prop> = ({ src, alt, description, title }) => {
  return (
    <div className="flex flex-col border rounded-[25px] w-[347px] bg-white  ">
      <Image
        className=" w-full mb-[59px]"
        src={src}
        alt={alt}
        width={347}
        height={249}
      ...
      <div className="ml-[38px] flex flex-col ">
        <span className="text-lg font-semibold leading-[22.5px] text-left text-darkblue mb-[14px]">
          {title}
        </span>
